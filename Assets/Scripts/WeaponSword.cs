...
public class WeaponSword: IWeapon
{
    ...
    public WeaponSword()
    {
        ...
        _attacks[1, 1, 1, 0, 0, 0] = new Attack(5, 5, 15, 10, 10, 0f, 0f, 0f, 0.1f, true);    //Three light attacks

        _attacks[2, 0, 0, 0, 0, 0] = new Attack(6, 4, 10, 10, 10, 0f, 0f, 0f, 0.1f, false);    //One heavy attack
        _attacks[2, 2, 0, 0, 0, 0] = new Attack(7, 4, 15, 15, 10, 0f, 0f, 0f, 0.1f,false);
        _attacks[2, 2, 2, 0, 0, 0] = new Attack(9, 6, 25, 25, 5, 0f, 0f, 0f, 0.1f, true);    //triple heavy is suppose to create room by knocking enemies backwards

       //Knock ups
        _attacks[1, 1, 2, 0, 0, 0] = new Attack(6, 8, 15, 5, 25, 0f, 0f, 0f, 0.1f, true);    //Ideal knockup combo - suppose to act as a way to knock them up - send them to the moon
        _attacks[2, 1, 0, 0, 0, 0] = new Attack(4, 6, 10, 5, 8, 0f, 0f, 0f, 0.1f, false);     //A weaker knock up
